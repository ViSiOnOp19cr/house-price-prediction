...
from house.components.data_validation import DataValidation
from house.components.data_transformation import DataTransformation                          
...
from house.entity.artifact_entity import DataTransformationArtifact
